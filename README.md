...
由於我認為專案如果只有單純的CRUD那就沒什麼特別的，因此我想要製作一個之後能夠加入AI Service的專案，目前的規劃是使用flask的微服務器，將message的內容進行斷句並輸入至embedding層轉成向量，再導入語意辨識的模型對message做違規偵測
...
2026/5/6  完成新增訊息的功能，使用者可以刪除訊息(對訊息做已刪除標記)，有標記的訊息不會顯示在前端(後端數位證據保留)
